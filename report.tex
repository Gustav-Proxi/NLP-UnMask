...
T5: Memory             & Mistake log + proactive revisit at 8 min (§\ref{sec:memory}) & \checkmark \\
Bonus: Dashboard       & Per-turn mastery panel (\textcolor{red}{$\bullet$}/\textcolor{orange}{$\bullet$}/\textcolor{green}{$\bullet$}); structured end-of-session report & \checkmark \\
...
Task~4 (VLM diagram tutoring) is the primary outstanding gap: Chainlit accepts
image uploads but the VLM backend is not yet integrated.
